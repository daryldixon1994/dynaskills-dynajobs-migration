              ...
              <div className="row align-items-center justify-content-center">
                <div className="col-lg-6 col-md-9 order-0 order-lg-2">
                  <div className="about-img-wrap-eleven">
                    <img
                      src="/assets/img/images/inner_about_img05.png"
                      alt=""
                    />
                    <img
                    ...
                    />
                    <img
                      src="/assets/img/images/inner_about_shape02.png"
                      alt=""
                      className="shape-two"
                    />
                  </div>
                ...
                <div className="col-lg-6">
                  <div className="about-content-eleven">
                    <div className="section-title mb-30">
                      ...
                      <h2 className="title">
                        Best Digital Solution <br /> Provider Agency
                      </h2>
                    </div>
                    <p>
                      when an unknown printer took a galley of type and
                      scrambled it ake a type specimen book. when an unknown
                      printer took a galley of type and scrambled it ake.
                    </p>
                    ...
                    <Link href="/services" className="btn btn-three">
                      Take our Service
                    </Link>
                  </div>
                </div>
              ...
              <div className="row align-items-center justify-content-center">
                ...
                <div className="col-lg-6">
                  <div className="about-content-six">
                    ...
                    <p>
                      Advice on comprehensive legal solutions and legal planning
                      on all aspects of business, including issues
                    </p>
